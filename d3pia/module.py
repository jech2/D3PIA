...
from d3pia.diffusion.trainer import DiscreteDiffusion, log_onehot_to_index
from d3pia.evaluate import evaluate 
...
class D3RM(DiscreteDiffusion):
    def __init__(self,
        ...
        if use_style_enc:
            ...
            from d3pia.external_encoder import load_pretrained_style_enc
        ...
        if use_chord_enc:
            ...
            from d3pia.external_encoder import load_pretrained_chd_enc
    ...
    def training_step(self, batch, batch_idx):
        ...
        style_emb = self._encode_style(prmat) # B x (4 x 256)
        chord_emb = self._encode_chord(polydis_chord) # B x (4 x 512)
