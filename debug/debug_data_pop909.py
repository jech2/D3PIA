...
data_dir = './data/POP909-Dataset/POP909_processed/train'
pr_res = 16

piano_roll_fps = Path(data_dir).rglob(f'*{pr_res}.npy')

out_dir = './debug/pr_fig_pop909'
...
for pr_fp in piano_roll_fps:
    ...
    # pianoroll2midi(piano_rolls[0], leadsheet=piano_rolls[1], out_fp=out_dir / f"{pr_fp.stem}.mid", pr_res=pr_res, unit='quantize_grid')
